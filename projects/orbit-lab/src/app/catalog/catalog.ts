...
export const CATALOG_ENTRIES: CatalogEntry[] = [
  ...
  { slug: 'button', label: 'Pulsanti', status: 'verified', icon: 'check' },
  ...
  { slug: 'sidebar', label: 'Sidebar', status: 'verified', icon: 'sidebar' },
  { slug: 'form-section', label: 'Sezioni modulo', status: 'verified', icon: 'grid' },
