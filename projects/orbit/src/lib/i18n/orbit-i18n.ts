...
export const DEFAULT_ORBIT_I18N: OrbitI18n = {
  ...
  labels: {
    ...
    select: 'Seleziona…', search: 'Cerca…', clearSearch: 'Cancella ricerca', openList: 'Apri elenco', noResults: 'Nessun risultato',
    openTimePicker: 'Apri selettore orario', hours: 'Ore', minutes: 'Minuti', timePicker: 'Selettore orario', nextHour: 'Ora successiva', previousHour: 'Ora precedente', nextMinutes: 'Minuti successivi', previousMinutes: 'Minuti precedenti', increaseValue: 'Aumenta valore', decreaseValue: 'Riduci valore', showPassword: 'Mostra password', hidePassword: 'Nascondi password', collapseSidebar: 'Riduci barra laterale', expandSidebar: 'Espandi barra laterale', segmentedControl: 'Selettore', removeChip: 'Rimuovi', previousPage: 'Pagina precedente', nextPage: 'Pagina successiva',
