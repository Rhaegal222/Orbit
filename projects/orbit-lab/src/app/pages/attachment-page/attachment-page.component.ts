...
export class AttachmentPageComponent {
  ...
  protected readonly editable = [
    {
      id: 'editable',
      name: 'report.pdf',
      metadata: 'PDF · 246 KB',
      actions: [
        { id: 'view', label: 'Visualizza', icon: 'view' as const },
        { id: 'download', label: 'Scarica', icon: 'download' as const },
        { id: 'remove', label: 'Rimuovi', icon: 'remove' as const },
      ],
    },
  ];
  ...
  protected readonly failed = [
    {
      id: 'failed',
      name: 'dati.zip',
      metadata: 'Errore di elaborazione',
      status: 'danger' as const,
      statusLabel: 'Non disponibile',
      actions: [{ id: 'retry', label: 'Riprova', icon: 'retry' as const }],
    },
  ];
}
