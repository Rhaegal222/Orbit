...
export const DEFAULT_ORBIT_I18N: OrbitI18n = {
  ...
  labels: {
    ...
    openTimePicker: 'Apri selettore orario', hours: 'Ore', minutes: 'Minuti', timePicker: 'Selettore orario', nextHour: 'Ora successiva', previousHour: 'Ora precedente', nextMinutes: 'Minuti successivi', previousMinutes: 'Minuti precedenti', increaseValue: 'Aumenta valore', decreaseValue: 'Riduci valore', showPassword: 'Mostra password', hidePassword: 'Nascondi password', collapseSidebar: 'Riduci barra laterale', expandSidebar: 'Espandi barra laterale', segmentedControl: 'Selettore', removeChip: 'Rimuovi',
