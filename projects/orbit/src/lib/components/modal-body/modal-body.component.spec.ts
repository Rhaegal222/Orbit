...
describe('OrbitModalBodyComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [OrbitModalBodyComponent],
    }).compileComponents();
  ...
  it('shows the labelled loading overlay', () => {
    ...
    fixture.detectChanges();
    expect(
      fixture.nativeElement.querySelector('.orbit-modal-body__loader-text').textContent,
    ).toContain('Caricamento elementi');
  });
});
