# Contributing to Galileo Orbit

## Boundaries

Keep Orbit independent from Galileo application domains. Do not import KMS API services, permissions, routes or business models.
